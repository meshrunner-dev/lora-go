...
func TestValidate(t *testing.T) {
	ok := Params{Frequency: 868e6, SF: SF8, BW: BW62500, CR: CR8}
	if err := ok.Validate(); err != nil {
		t.Fatalf("valid params rejected: %v", err)
	}
	for name, bad := range map[string]Params{
		"no frequency": {SF: SF8, BW: BW62500, CR: CR8},
		"SF too low":   {Frequency: 868e6, SF: 4, BW: BW62500, CR: CR8},
		"SF too high":  {Frequency: 868e6, SF: 13, BW: BW62500, CR: CR8},
		"odd BW":       {Frequency: 868e6, SF: SF8, BW: 100000, CR: CR8},
		"odd CR":       {Frequency: 868e6, SF: SF8, BW: BW62500, CR: 9},
	} {
